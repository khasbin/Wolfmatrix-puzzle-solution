...
def solution(con1:str, con2:str, con3:str, con4:str, con5:str):
    ...
    for number in range(1000):
        if checknumbers(number,con1, 1, 0) and checknumbers(number,con2, 1, 1) and checknumbers(number,con3, 2, 0) and checknumbers(number,con4, 0, 0) and checknumbers(number,con5, 1, 0):
            print(f'The required solution is {number}')
            break
